...
-- at runtime using the environment variable lzma_conduit_bindir.
...
-- environment variable lzma_conduit_libdir.
...
-- using the environment variable lzma_conduit_dynlibdir.
...
-- runtime using the environment variable lzma_conduit_datadir.
...
-- variable lzma_conduit_libexedir.
...
-- using the environment variable lzma_conduit_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/lzma-conduit-1.2.3-inplace-lzma-test"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/lzma-conduit-1.2.3"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/lzma-conduit-1.2.3"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "lzma_conduit_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "lzma_conduit_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "lzma_conduit_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "lzma_conduit_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "lzma_conduit_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "lzma_conduit_sysconfdir") (\_ -> return sysconfdir)
